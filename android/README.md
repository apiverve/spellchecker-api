...
```gradle
dependencies {
    implementation 'com.github.apiverve:spellchecker-api:1.1.14'
}
```
...
```java
import com.apiverve.spellchecker.SpellCheckerAPIClient;
import com.apiverve.spellchecker.APIResponse;
import com.apiverve.spellchecker.APIException;

// Initialize the client
SpellCheckerAPIClient client = new SpellCheckerAPIClient("YOUR_API_KEY");

try {
    // Prepare request parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("text", "I neeed to call my friend on telephine today!");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/spellchecker](https://docs.apiverve.com/ref/spellchecker)
...
- **Documentation:** [https://docs.apiverve.com/ref/spellchecker](https://docs.apiverve.com/ref/spellchecker)
- **Issues:** [GitHub Issues](https://github.com/apiverve/spellchecker-api/issues)
