# Spell Checker API - Examples

This folder contains example code for using the Spell Checker API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/spellchecker',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/spellchecker");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/spellchecker](https://docs.apiverve.com/ref/spellchecker)
