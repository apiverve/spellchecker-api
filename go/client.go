...
const (
	baseURL        = "https://api.apiverve.com/v1/spellchecker"
	defaultTimeout = 30 * time.Second
)

// Client is the Spell Checker API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Spell Checker API client.
...
// Execute makes a request to the Spell Checker API with typed parameters.
//
