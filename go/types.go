// Package spellchecker provides a Go client for the Spell Checker API.
//
// For more information, visit: https://apiverve.com/marketplace/spellchecker?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the Spell Checker API.
//
// Parameters:
//   - text (required): string - The text to check the spelling of
type Request struct {
...
// ResponseData contains the data returned by the Spell Checker API.
type ResponseData struct {
	SpellPass bool `json:"spellPass"`
	MispellingsFound int `json:"mispellingsFound"`
	Corrections []CorrectionsItem `json:"corrections"`
}

// CorrectionsItem represents an item in the Corrections array.
type CorrectionsItem struct {
